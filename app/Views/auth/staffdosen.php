                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        ?>
                                        <?php echo form_open('login/authstaffdosen'); ?>
                                        <?= csrf_field() ?>
                                        <!-- NIP -->
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input autocomplete="off" autofocus="on" type="text" class="form-control <?= $validation->hasError('nip') ? 'is-invalid' : '' ?>" id="nip" name="nip" placeholder="Nomer Induk Pegawai | NIP" value="<?= old('nip') ?>">
