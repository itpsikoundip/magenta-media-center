...
<div class="app-content content">
    <div class="container mt-4">
        ...
        <hr class="mb-2 mt-0">
        <?php if ($detailMahasiswa['reset_pass'] == 0) { ?>
            <div class="alert alert-danger mb-2" role="alert">
                <strong>PERHATIAN!</strong> Anda belum mengubah password! ubah di halaman <strong><u><a href="<?= base_url('mahasiswa/profil') ?>"> Profil </a></u></strong> untuk mengakses fitur MMC!
            </div>
        <?php } elseif ($detailMahasiswa['reset_pass'] == 1) { ?>
