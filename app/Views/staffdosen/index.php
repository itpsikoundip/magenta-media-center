            ...
            <div class="content-body">
                <div class="row">
                    ...
                    <?php if (session()->get('proposal') == 1) { ?>
                        <div class="col-xl-3 col-lg-6 col-12">
                            <a class="card" href="<?= base_url('staffdosen/proposal') ?>">
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="align-self-center">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="align-self-center">
                                            <i class="icon-folder-alt light font-large-2 float-left"></i>
                                        </div>
                                        <div class="media-body text-right">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="align-self-center">
                                            <i class="icon-folder light font-large-2 float-left"></i>
                                        </div>
                                        <div class="media-body text-right">
