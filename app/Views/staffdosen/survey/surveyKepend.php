                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('/staffdosen/survey/surveykepend/addsurveykepend') ?>" method="post">
                                <?= csrf_field(); ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-danger" href="<?= base_url('/staffdosen/survey/surveykepend/deletesurveykepend/' . $row["pertanyaan"]) ?>" role="button">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Aksi ini akan menghapus :
                                ...
                                <a href=" <?= base_url('/staffdosen/survey/exportkepend') ?>"><i class="ft-download-cloud"></i> Export Kependidikan </a>
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-danger" href="<?php echo base_url('/staffdosen/survey/truncatekepend') ?>" role="button"><i class="ft-alert-triangle"></i> Hapus</a>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        </div>
                    </div>
                </div>
