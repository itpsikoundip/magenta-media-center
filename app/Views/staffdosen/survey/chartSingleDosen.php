<div class="app-content content">
    <div class="content-wrapper">
        <div class="content-body">
            <div class="card">
                <h1 class="text-center mt-2 mb-1"><b><?php echo $namaDosen ?></b></h1>
                <div class="row">
                    <?php if ($arrayPertanyaan == "Tidak ada pertanyaan survey dosen") {
                        echo '<div class="col text-center m-4">';
                        echo '<p><b>' . $arrayPertanyaan . '</b></p>';
                        echo '<br>';
                        echo '<a class="btn btn-primary m-auto" href="' . base_url('/staffdosen/survey/surveydosen') . '" role="button" style="background-color: #f1457e !important; border: 0 !important;">
                                Tambah Pertanyaan</a>';
                        echo '</div>';
                    } else {
            ...
            <div class="card">
                <h1 class="text-center mt-2 mb-1"><b>Saran Untuk Dosen</b></h1>
                <div class="mx-3">
                    <table id="tbl_dataSaranDosen" class="table table-bordered mb-3 zero-configuration">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php
                            $numbering = 1;
                            foreach ($dataSaranDosen as $row) :
                                $date = strtotime($row["created_at"]);
                            ?>
                                <tr>
                                    <td class="text-center align-middle"><?= $numbering++; ?></td>
                                    <td class="align-middle"><?= $row["saran_dosen"]; ?></td>
