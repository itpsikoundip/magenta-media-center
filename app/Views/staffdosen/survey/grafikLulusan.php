            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    if ($arrayPertanyaan == "Tidak ada pertanyaan survey lulusan") {
                        ...
                        echo '<br>';
                        echo '<a class="btn btn-primary m-auto" href="' . base_url('/staffdosen/survey/surveylulusan') . '" role="button" style="background-color: #f1457e !important; border: 0 !important;">
                                Tambah Pertanyaan</a>';
                        echo '</div>';
                    } else {
