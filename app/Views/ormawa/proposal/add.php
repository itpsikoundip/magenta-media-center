<div class="app-content content">
    <div class="container mt-4">
        ...
        <?php } ?>
        <a href="<?= base_url('ormawa/proposal') ?>" class="btn btn-sm btn-secondary mr-1 mb-1"><i class="fa fa-chevron-left"></i> Kembali</a>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <?php
                                    echo form_open_multipart('ormawa/proposal/adddata');
                                    ?>
                                    <div class="form-body">
