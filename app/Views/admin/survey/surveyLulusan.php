                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-danger" href="<?= base_url('surveylulusan/deleteSurveyLulusan/' . $row["id"]) ?>" role="button">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Aksi ini akan menghapus :
                                ...
                                <a href=" <?= base_url('/exportLulusan') ?>"><i class="ft-download-cloud"></i> Export Lulusan </a>
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-danger" href="<?php echo base_url('/truncateLulusan') ?>" role="button"><i class="ft-alert-triangle"></i> Hapus</a>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        </div>
                    </div>
                </div>
