                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h1>Tabel Hasil Survey Lulusan</h1>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <table id="tbl_dataHasilSurveyDosen" class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php $numbering = 1;
                                            foreach ($dataHasilSurveyLulusan as $row) : ?>
                                                <tr>
                                                    <td><?= $numbering++ ?></td>
                                                    <td><?= $row["pertanyaan"] ?></td>
                                                    <td>
                                                        <a href="#" class="badge badge-info" data-toggle="modal" data-target="#ModalHasilSurveyLulusan"><i class="ft-bar-chart-2"></i> Hasil</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
...
<div class="modal fade" id="ModalHasilSurveyLulusan" arta-labelledby="ModalHasilSurveyLulusanLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalHasilSurveyLulusan"></h5>
