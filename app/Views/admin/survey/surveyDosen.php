                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Aksi ini akan menghapus :
                                ...
                                <a href=" <?= base_url('/exportDosen') ?>"><i class="ft-download-cloud"></i> Export Dosen </a>
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-danger" href="<?php echo base_url('/truncateDosen') ?>" role="button"><i class="ft-alert-triangle"></i> Hapus</a>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        </div>
                    </div>
                </div>
