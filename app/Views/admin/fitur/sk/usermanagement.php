                                            ...
                                            foreach ($allDataUserOp as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;">
                                                        <button type="button" class="btn btn-success mr-1 mb-1" data-toggle="modal" data-target="#editOperator<?= $value['id_sk_user_op']  ?>"><i class="ft-edit"></i> Edit</button>
                                                        <button type="button" class="btn btn-danger mr-1 mb-1" data-toggle="modal" data-target="#deleteOperator<?= $value['id_sk_user_op']  ?>"><i class="ft-trash"></i> Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php  } ?>
                                        </tbody>
...
<!-- Add Modal User Operator -->
<div class="modal fade text-left" id="addModalUserOp" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title text-text-bold-600">Tambah <?= $title ?></label>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php
            echo form_open('admin/fitur/sk/usermanagement/addop');
            ?>
...
<!-- End of Add Modal User Operator -->

<!-- Delete Modal User Operator -->
<?php
foreach ($allDataUserOp as $key => $value) { ?>
    <div class="modal fade text-left" id="deleteOperator<?= $value['id_sk_user_op']  ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel10" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('admin/fitur/sk/usermanagement/deleteop/' . $value['id_sk_user_op']) ?>" class="btn btn-outline-danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
<?php  } ?>
<!-- End of Delete Modal User Operator -->

<!-- Edit Modal User Operator -->
<?php
foreach ($allDataUserOp as $key => $value) { ?>
    <div class="modal fade text-left" id="editOperator<?= $value['id_sk_user_op']  ?>" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600">Edit <?= $title ?></label>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <?php
                echo form_open('admin/fitur/sk/usermanagement/editop/' . $value['id_sk_user_op']);
                ?>
                <div class="modal-body">
                    <label>Staff & Dosen : </label>
                    <div class="form-group">
...
<?php  } ?>
<!-- End of Edit Modal User Operator -->

<!-- Add Modal User Verifikator -->
<div class="modal fade text-left" id="addModalUserVerifikator" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title text-text-bold-600">Tambah <?= $title ?></label>
            ...
            <?php
            echo form_open('admin/fitur/sk/usermanagement/addverif');
            ?>
            <div class="modal-body">
                <p>Nama yang muncul adalah nama yang memiliki akses SK. Jika nama tidak ditemukan, tambahkan akses SK terlebih dahulu di tab / menu lain</p>
                <label>Staff & Dosen : </label>
...
<!-- End of Add Modal User Verifikator -->

<!-- Delete Modal User Verifikator -->
<?php
foreach ($allDataUserVerifikator as $key => $value) { ?>
    <div class="modal fade text-left" id="deleteVerifikator<?= $value['id_sk_user_verifikator']  ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel10" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Batal</button>
                    <a href="<?= base_url('admin/fitur/sk/usermanagement/deleteverif/' . $value['id_sk_user_verifikator']) ?>" class="btn btn-outline-danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
<?php  } ?>
<!-- End of Delete Modal User Verifikator -->

<!-- Modal Edit User Verifikator -->
<?php
foreach ($allDataUserVerifikator as $key => $value) { ?>
    <div class="modal fade text-left" id="editVerifikator<?= $value['id_sk_user_verifikator']  ?>" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600">Edit <?= $title ?></label>
                ...
                <?php
                echo form_open('admin/fitur/sk/usermanagement/editverif/' . $value['id_sk_user_verifikator']);
                ?>
                <div class="modal-body">
                    <label>Staff & Dosen : </label>
                    <div class="form-group">
...
<?php  } ?>
<!-- End of Modal Edit User Verifikator -->